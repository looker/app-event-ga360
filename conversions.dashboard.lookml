- dashboard: conversions
  ...
  - title: Conversions
    ...
    - ga_sessions.selected_goal_converions
    filters:
      geoNetwork.country: ''
      ga_sessions.date_period_comparison_period: 'Yes'
    sorts:
    ...
    - table_calculation: total_transactions
      ...
      _kind_hint: measure
      _type_hint: number
    - table_calculation: selected_goal_converions
      label: Goal Conversions
      expression: "(${ga_sessions.selected_goal_converions} - offset(${ga_sessions.selected_goal_converions},\
        \ 1)) / offset(${ga_sessions.selected_goal_converions}, 1)"
      value_format:
      value_format_name: percent_2
      _kind_hint: measure
      _type_hint: number
  ...
  - title: Returning User Conv Rate
    ...
    fields:
    - ga_sessions.date_period
    - ga_sessions.selected_goal_converion_rate
    filters:
      geoNetwork.country: ''
      ga_sessions.date_period_comparison_period: 'Yes'
      ga_sessions.visitnumber: not 1
    ...
    - table_calculation: selected_goal_converions
      label: Goal Conversions
      expression: "(${ga_sessions.selected_goal_converion_rate} - offset(${ga_sessions.selected_goal_converion_rate},\
        \ 1)) / offset(${ga_sessions.selected_goal_converion_rate}, 1)"
      value_format:
      value_format_name: percent_2
      _kind_hint: measure
      _type_hint: number
  ...
  - title: Conversions Over Time
    ...
    point_style: circle_outline
    series_colors:
      ga_sessions.selected_goal_converions: "#FF666C"
      ga_sessions.selected_goal_converion_rate: "#58A9F5"
    ...
    - label:
      orientation: left
      series:
      - id: ga_sessions.selected_goal_converions
        name: Goal Conversions
        axisId: ga_sessions.selected_goal_converions
        __FILE: 91b39630a0c7233f58a1fcd7ee4e38a4accb75b2904960d79b2373f6b4168ce48dc3a2df/conversions.dashboard.lookml
        __LINE_NUM: 1661
      showLabels: false
      showValues: false
    ...
    - label: ''
      orientation: left
      series:
      - id: ga_sessions.selected_goal_converion_rate
        name: Goal Conversion Rate
        axisId: ga_sessions.selected_goal_converion_rate
        __FILE: 91b39630a0c7233f58a1fcd7ee4e38a4accb75b2904960d79b2373f6b4168ce48dc3a2df/conversions.dashboard.lookml
        __LINE_NUM: 1691
      showLabels: false
      showValues: false
  ...
  - title: Top Medium
    ...
    series_types:
      ga_sessions.selected_goal_converion_rate: line
      ga_sessions.selected_goal_converions: line
    limit_displayed_rows: false
    hidden_series:
    - ga_sessions.selected_goal_converions
    y_axes:
  ...
  - title: Top Converting Landing Pages
    ...
    filters:
      ga_sessions.date_period_latest: 'Yes'
    sorts:
    - ga_sessions.selected_goal_converions desc
    limit: 25
    column_limit: 10
    show_view_names: false
    show_row_numbers: true
  ...
  - name: Goal Selection
    ...
    type: field_filter
    default_value: Confirmation/Demo
    allow_multiple_values: true
    required: false
    model: app
    explore: app
